...
import { doc, getDoc, addDoc, getDocs, deleteDoc, updateDoc, query, where } from 'firebase/firestore';
...
const login = async () => {
    ...
    if (flag) {
        ...
        // user or admin route will change (future work)
        router.push('/admin/dashboard');
    } else {
        alert('there is no users please create a new user form registration !');
    }
};
</script>
