            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div>
                        ...
                        <InputText id="email1" type="text" placeholder="Your name" class="w-full md:w-[30rem] mb-8" v-model="state.name" />
                        ...
                        <InputText id="email1" type="phone" placeholder="Your Phone" class="w-full md:w-[30rem] mb-8" v-model="state.phone" />

                        <label class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Address</label>
                        <InputText type="text" placeholder="Your Address" class="w-full md:w-[30rem] mb-8" v-model="state.address" />

                        <label class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Birthdate</label>
                        <InputText type="date" placeholder="Your Birthdate" class="w-full md:w-[30rem] mb-8" v-model="state.birthdate" />
                        ...
                        <Button @click="createAccountForUser" label="Create account" class="w-full"></Button>
                    </div>
                </div>
            </div>
        </div>
